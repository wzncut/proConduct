...
//        System.out.println(JSON.toJSONString(res));
        ...
        pro.loadFile2(proConduct.fileToPath("/moocfinal4.txt"),proConduct.fileToPath("./group.txt"));
        //对数据集进行聚类（输出）
        pro.groupOutPut(pro.arrs,pro.group);


        //proConduct conduct = new proConduct();
        pro.loadFile3(proConduct.fileToPath("/result.txt"),proConduct.fileToPath("/group.txt"),"src/main/resources/ANN.txt");
    }
}
